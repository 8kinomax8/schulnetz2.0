...
* **API Anthropic Codex**: Analyse de documents (bulletins, captures d'écran SAL)
* **Endpoint `/api/scan`**: Traite les images via l'API Codex pour extraire les notes
