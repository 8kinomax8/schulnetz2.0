...
- **2026‑04‑18** : ajout du rate‑limiting DB pour le scan.
- **2026‑03‑22** : migration du schéma EFZ (modules, ÜK, IPA).
- **2026‑02‑15** : mise à jour du calcul de la `maturnote` globale (arrondi décimal corrigé).

---

## Références des méthodes et exportations
*(voir le tableau détaillé dans le fichier original – conservé pour les développeurs)*
